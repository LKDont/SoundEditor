...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-videotoolbox --disable-encoders --enable-encoder=png --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=vp6f --enable-decoder=flac --enable-decoder=hevc --enable-decoder=vp8 --enable-decoder=vp9 --disable-hwaccels --disable-muxers --enable-muxer=mp4 --enable-muxer=adts --enable-muxer=mp3 --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=flac --enable-demuxer=hevc --enable-demuxer=webm_dash_manifest --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=flac --enable-parser=hevc --enable-parser=mpegaudio --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --disable-bsf=eac3_core --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --disable-filters --enable-filter=volume --enable-filter=aformat --enable-filter=format --enable-filter=scale --enable-filter=aresample --enable-filter=resample --enable-filter=amix --disable-devices --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib --arch=x86 --cpu=i686 --enable-yasm --enable-openssl --enable-libmp3lame --enable-encoder=libmp3lame --enable-libfdk-aac --enable-encoder=libfdk_aac --enable-decoder=libfdk_aac --prefix=/mnt/e/Workspace/Android/BuildScripts-ijkplayer/android/ijkplayer-android/android/contrib/build/ffmpeg-x86/output --cross-prefix=i686-linux-android- --enable-cross-compile --target-os=linux --enable-pic --disable-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/mnt/e/Workspace/Android/BuildScripts-ijkplayer/android/ijkplayer-android/android/contrib/build/openssl-x86/output/include -I/mnt/e/Workspace/Android/BuildScripts-ijkplayer/android/ijkplayer-android/android/contrib/build/mp3lame-x86/output/include -I/mnt/e/Workspace/Android/BuildScripts-ijkplayer/android/ijkplayer-android/android/contrib/build/fdk-aac-x86/output/include -march=atom -msse3 -ffast-math -mfpmath=sse' --extra-ldflags=' -L/mnt/e/Workspace/Android/BuildScripts-ijkplayer/android/ijkplayer-android/android/contrib/build/openssl-x86/output/lib -lssl -lcrypto -L/mnt/e/Workspace/Android/BuildScripts-ijkplayer/android/ijkplayer-android/android/contrib/build/mp3lame-x86/output/lib -lmp3lame -L/mnt/e/Workspace/Android/BuildScripts-ijkplayer/android/ijkplayer-android/android/contrib/build/fdk-aac-x86/output/lib -lfdk-aac -lm '"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/mnt/e/Workspace/Android/BuildScripts-ijkplayer/android/ijkplayer-android/android/contrib/build/ffmpeg-x86/output/share/ffmpeg"
#define AVCONV_DATADIR "/mnt/e/Workspace/Android/BuildScripts-ijkplayer/android/ijkplayer-android/android/contrib/build/ffmpeg-x86/output/share/ffmpeg"
...
#define CONFIG_IJKOFFLINEHOOK_DEMUXER 0
